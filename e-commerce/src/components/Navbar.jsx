...
function Navbar({handleOrderPopup}) {
  return (
    <div className='bg-white dark:bg-gray-900 dark:text-white duration-200 relative z-40'>
                ...
                <div className='hidden lg:block'>
                    <ul className='flex items-center gap-4'>
                        ...
                        <li className='relative cursor-pointer group'>
                           ...
                           group-hover:block w-[200px] rounded-m bg-white shadow-md dark:bg-gray-900 p-2 dark:text-white'>
                               <ul className='space-y-2'>
                                {DropdownLinks.map((data, index) => (
                                        <li>
                                       <a 
                                       className='text-gray-500  dark:hover:text-white 
                                       duration-200 inline-block w-full p-2 hover:bg-primary/20 rounded-md font-semibold'
      ...
      dark:text-gray-400 duration-200  
